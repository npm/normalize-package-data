...
function fixBundleDepedenciesField (data, warn) {
...
function fixDependencies (data, warn) {
  ...
  fixBundleDepencenciesField(data, warn)
}
...
function fixKeywords (file, data) {
...
function fixPeople (data, warn) {
  modifyPeopleFields(data, unParsePerson)
  modifyPeopleFields(data, parsePerson)  
}
